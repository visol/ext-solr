...
class Tx_Solr_Facet_SimpleFacetRendererTest extends Tx_Phpunit_TestCase {
	...
	public function setUp() {
		...
		$parentPlugin       = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance('Tx_Solr_PiResults_Results');
		$parentPlugin->cObj = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance('tslib_cObj');
		$parentPlugin->main('', array());
		$query = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance('Tx_Solr_Query', array('test'));
